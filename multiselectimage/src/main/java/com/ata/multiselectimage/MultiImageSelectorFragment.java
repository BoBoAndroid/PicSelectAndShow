...
import com.ata.multiselectimage.adapter.FolderAdapter;
import com.ata.multiselectimage.adapter.ImageGridAdapter;
import com.ata.multiselectimage.bean.Folder;
import com.ata.multiselectimage.bean.Image;
import com.ata.multiselectimage.utils.FileProvider7;
import com.ata.multiselectimage.utils.FileUtils;
import com.ata.multiselectimage.utils.ScreenUtils;
...
public class MultiImageSelectorFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        if(isTakePhoto()){
            filePath=getArguments().getString(EXTRA_PHOTO_PATH);
            showCameraAction();
        }else {
        ...
        if(ContextCompat.checkSelfPermission(getContext(), Manifest.permission.WRITE_EXTERNAL_STORAGE)
            ...
            if (intent.resolveActivity(getActivity().getPackageManager()) != null) {
                ...
                if (mTmpFile != null && mTmpFile.exists()) {
                    Uri uri= FileProvider7.getUriForFile(getActivity(), mTmpFile);
